<h2><a href="https://www.geeksforgeeks.org/problems/right-triangle/1?page=8&difficulty=Easy&status=solved&sortBy=submissions">Pattern 2</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Geek is very fond of patterns. Once, his teacher gave him a pattern to solve. He gave Geek&nbsp;an integer n and asked him to build a pattern.</span></p>
